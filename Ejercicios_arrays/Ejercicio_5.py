...
def chequea_y_retorna_menores_edad(nombres: list, edades: list) -> list:
    """
    Función que recibe dos listas: nombres y edades, y retorna una lista con los nombres
    de las personas que tienen la edad mínima (si hay más de una, retorna todos los nombres).
    ...
    # Retornamos la lista con los nombres de las personas de menor edad
    return lista_nombres_menores_edad


# Definimos las listas de nombres y edades de las personas
nombres = ["Ana", "Luis", "Juan", "Sol", "Roberto", "Sonia", "Ulises", "Sofia", "Maria", "Pedro", "Antonio", "Eugenia", "Soledad", "Mario", "Mariela"]
edades = [23, 45, 34, 23, 46, 23, 45, 67, 37, 68, 25, 55, 45, 27, 43]

# Llamamos a la función para obtener los nombres de las personas con la edad mínima
...
# Recorremos la lista de nombres de las personas con la edad mínima
...
# Comprobamos si solo hay una persona de menor edad, y mostramos un mensaje adecuado
